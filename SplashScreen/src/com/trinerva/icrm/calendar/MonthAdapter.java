...
public class MonthAdapter extends ArrayAdapter<CalendarData> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			case TYPE_2:
					...
					convertView = inflater.inflate(R.layout.calendar_task_item, parent,
							false);
		...
		case TYPE_2:
			...
			holder.mSubject.setText(data.monthTask);


			break;
		case TYPE_3:
			System.out.println("data.startDate = "+data.startDate);
				holder.mStartDate.setText(data.startDate);
			
			holder.mSubject.setText(data.monthTask);
			
			holder.mNameTo.setText(data.nameToName);
...
//		});
	...
	public MonthAdapter(Context context, List<CalendarData> data) {
	...
	class ViewHolder {
		TextView mDay, mDayTitle, mStartDate, mSubject,mNameTo;
		ImageView cSync;
