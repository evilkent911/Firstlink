...
//
//public class CreateContactInfoBesiaFragment extends Fragment {
//
...
//			home_phone, birthday, email2, email3, skype_id, assistant_name,
...
//		// properly.
//		View v = inflater.inflate(R.layout.fragment_contact_info, container,
//				false);
//
...
//	// getString(R.string.last_name_is_required), getString(R.string.ok));
//	// doLockField(false);
//	// last_name.requestFocus();
//	// } else if (strCompanyName.length() == 0) {
//	// GuiUtility.alert(getActivity(), "",
//	// getString(R.string.company_name_is_required), getString(R.string.ok));
//	// doLockField(false);
//	// company_name.requestFocus();
//	// } else if (strEmail.length() > 0 && !Utility.isValidEmail(strEmail)) {
//	// GuiUtility.alert(getActivity(), "", getString(R.string.email_error_msg),
...
//	// GuiUtility.alert(getActivity(), "", getString(R.string.phone_error_msg),
//	// getString(R.string.ok));
//	// doLockField(false);
//	// mobile.requestFocus();
...
//	// GuiUtility.alert(getActivity(), "", getString(R.string.skype_error_msg),
//	// getString(R.string.ok));
//	// doLockField(false);
//	// skype_id.requestFocus();
//	// } else {
//	// DeviceUtility.log(TAG, "isContainWhitespace: " +
//	// Utility.isContainWhitespace(strSkype));
//	// //save
...
//			AsyncTask<HashMap<String, String>, Void, ContactDetail> {
//		@Override
//		protected void onPreExecute() {
//			super.onPreExecute();
//			loadingDialog = GuiUtility.getLoadingDialog(getActivity(), false,
...
//
//		@Override
//		protected ContactDetail doInBackground(
...
//							"oContactDetail: " + oContactDetail.toString());
//					DeviceUtility.log(TAG, "oContactDetail.getContactId: "
//							+ oContactDetail.getContactId());
//				} else if (hAction.get("ACTION").equalsIgnoreCase("LOAD")) {
//					oContactDetail = ContactUtility.getContact(getActivity(),
//							strId);
//				}
//			}
...
//			if (result.getPrefix() != null) {
//				prefixSpinner
//						.setSelection(Integer.parseInt(result.getPrefix()));
//			}
//
...
//    			
//    			intent2.putExtra("company_name", company_name.getText().toString());
//    			intent2.putExtra("last_name", last_name.getText().toString());
//    			intent2.putExtra("first_name", first_name.getText().toString());
//    			intent2.putExtra("prefixSpinner", prefixSpinner.getSelectedItemPosition());
...
//    			intent2.putExtra("department", department.getText().toString());
//    			intent2.putExtra("other_phone", other_phone.getText().toString());
//    			intent2.putExtra("home_phone", home_phone.getText().toString());
//    			
