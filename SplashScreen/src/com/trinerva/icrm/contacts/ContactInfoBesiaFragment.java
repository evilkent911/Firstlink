...
public class ContactInfoBesiaFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(ContactInfoTab.lastName != null ){
		lastName = ContactInfoTab.lastName;
		}
...
//				work_phone.requestFocus();
				...
				if (strMobile.length() == 0) {
					...
					System.out.println("Mobile No after format"+strMobile);
				...
				if (strWorkFax.length() == 0) {
					...
					System.out.println("Fax No after format " + strWorkFax);
				...
				if (strWorkPhone.length() == 0) {
					...
					System.out.println("Phone No after format " + strWorkPhone);
				...
				if (strOtherPhone.length() == 0) {
					...
					System.out.println("Phone No after format " + strOtherPhone);
	...
	public void doLockField(boolean bLock) {
		...
		if (bLock == true) {
			bEnabled = false;
			bFocusabled = false;
			//company_name.setTextColor(Color.WHITE);
		}else{
			company_name.setTextColor(Color.BLACK);
		}
	...
	private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(intent.getAction().equals("editPage")){
				...
				intent.putExtra("strPrefix", strPrefix);
				intent.putExtra("strJobTitle", strJobTitle);
				intent.putExtra("strMobile", strMobile);
				intent.putExtra("strEmail", strEmail);
				intent.putExtra("strWorkPhone", strWorkPhone);
				intent.putExtra("strWorkFax", strWorkFax);
				intent.putExtra("strStreet", strStreet);
...
//				intent.putExtra("strDepartment", strDepartment);
//				intent.putExtra("strOtherPhone", strOtherPhone);
//				intent.putExtra("strHomePhone", strHomePhone);
