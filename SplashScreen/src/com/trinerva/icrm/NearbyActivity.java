...
//	public FragmentActivity fa;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tab_nearby);
		
		context = this;
		
		km0 = (TextView) findViewById(R.id.km0);
		km5 = (TextView) findViewById(R.id.km5);
		km10 = (TextView) findViewById(R.id.km10);
		km15 = (TextView) findViewById(R.id.km15);
	...
	private OnItemClickListener doGetDetail = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			NearbyActivity.this.startActivity(iMap);			
		}
	};
	...
	public void onResume() {
		...
		service.requestLocationUpdates(provider, 5000, 1, NearbyActivity.this);
	...
	private OnClickListener distanceSelection = new OnClickListener() {
		...
		public void onClick(View v) {
			if (loadingDialog == null) {
				loadingDialog = GuiUtility.getLoadingDialog(context, false, null);
			} else {
	...
	private class Nearby extends AsyncTask<Location, Void, ArrayList<CoordinateDetail>> {
		...
		protected void onPostExecute(ArrayList<CoordinateDetail> result) {
			...
			//do adapter.
			adapter = new CoordinateAdapter(context, aCoordinateList, DISTANCE_CAT);
			if (adapter.isEmpty()) {
				empty_list.setVisibility(View.VISIBLE);
				list.setVisibility(View.GONE);
			} else {
			...
			if (!bCloseLoading && bEnabled) {
				loadingDialog = GuiUtility.getLoadingDialog(context, true, getString(R.string.loading_location));
			}
		}
	}
	...
	public void onProviderDisabled(String arg0) {
		...
		GuiUtility.alert(context, getString(R.string.turn_on_location_title), getString(R.string.turn_on_location_desc), Gravity.CENTER, getString(R.string.settings),
