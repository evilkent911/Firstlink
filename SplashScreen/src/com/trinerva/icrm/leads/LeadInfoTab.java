...
import com.trinerva.icrm.contacts.OpportunityList;
...
public class LeadInfoTab extends FragmentActivity {
	@Override
	...
	private String TAG = "LeadInfoTab";
...
bIsContact = bundle.getBoolean(Constants.IS_CONTACT_NAME_TO, false);
		...
		mDelete.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				GuiUtility.alert(LeadInfoTab.this, "",
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								Dialog loading = GuiUtility.getLoadingDialog(
										LeadInfoTab.this, false,
										getString(R.string.processing));
								DatabaseUtility
										.getDatabaseHandler(LeadInfoTab.this);
								Contact contact = new Contact(
										Constants.DBHANDLER);
								contact.delete(strId);
								loading.dismiss();
								// back to contact list.
								LeadInfoTab.this.finish();
							}
						});
			}
		});
		...
		findViewById(R.id.createEvent).setOnClickListener(
				new OnClickListener() {
					...
					@Override
					public void onClick(View v) {
						Intent event = new Intent(LeadInfoTab.this,
								EventInfo.class);
						...
						LeadInfoTab.this.startActivity(event);
					}
				});
		...
		findViewById(R.id.createTask).setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent event = new Intent(LeadInfoTab.this, TaskInfo.class);
				event.putExtra("NAME_TO", nameTo);
				event.putExtra("EDIT_NAME_TO", false);
				event.putExtra("OTHER_PAGE_TO", true);
				LeadInfoTab.this.startActivity(event);
	...
	private static String formatCallNumber(String phoneNo){
		...
		if (phoneNo.charAt(0) == '0')		
			...
			phoneNo = "+" + phoneNo;
		System.out.println("New phoneNo is " + phoneNo);
		return phoneNo;
	}
	...
	private class SaveContact extends AsyncTask<ContactDetail, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			loadingDialog = GuiUtility.getLoadingDialog(LeadInfoTab.this,
		...
		protected Boolean doInBackground(ContactDetail... params) {
			...
			DatabaseUtility.getDatabaseHandler(LeadInfoTab.this);
				...
				GuiUtility.alert(LeadInfoTab.this,
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								// Intent iContact = new
								// Intent(LeadInfoTab.this,
								// ContactList.class);
								// LeadInfoTab.this.startActivity(iContact);
								LeadInfoTab.this.finish();
							}
						}, "", null);
			} else {
	...
	private class LoadContact extends AsyncTask<String, Void, ContactDetail> {
		...
		protected void onPostExecute(ContactDetail result) {
			...
			// StorageUtility storage = new StorageUtility(LeadInfoTab.this,
		...
		private OnClickListener doComposeEmail = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(LeadInfoTab.this);
...
//				System.out.println("call = "+aContactNumberList.get(0).getPhoneNo());
	...
	private void doLogActivity(String strActionType, String strActionInfo) {
		DatabaseUtility.getDatabaseHandler(LeadInfoTab.this);
		String strOwner = Utility.getConfigByText(LeadInfoTab.this,
				"USER_EMAIL");
